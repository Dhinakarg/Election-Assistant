        ...
        <header className="bg-indigo-600 text-white shadow-md">
          <div className="max-w-6xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-white p-1.5 rounded-lg cursor-pointer" onClick={() => setCurrentView('chat')}>
          ...
          <div className="space-y-6 overflow-y-auto pr-1 pb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="text-xl">💬</span> {t('nav.chat')}
                </button>
                <button 
                ...
                >
                  <span className="text-xl">📋</span> {t('nav.checklist')}
                </button>
                <button 
                ...
                >
                  <span className="text-xl">🗺️</span> Voter Journey
                </button>
                <button 
                ...
                >
                  <span className="text-xl">🗳️</span> {t('nav.ballot')}
                </button>
                <button 
                ...
                >
                  <span className="text-xl">🧠</span> {t('nav.quiz')}
                </button>
              </div>
            </div>
